...
<!--FORMULÁRIO-->
<form method="post" action="../../BACK-END/PHP/DESPESA/CAD/cadastrar.php">
			...
			<td style="background-color: #252B30;border-radius: 10px;box-shadow: 1.5px 1.5px 1.5px black;">
				...
				<table align="center" cellspacing="5px" style="height: 120px;width: 90%;">
					...
					<tr>
						...
						<!--TITULO-->
						<td style="color: gray;font-size: 20px;font-weight: bold;vertical-align: bottom;width: 80%;">Cadastrar Despesa</td>
					</tr>
				...
				<table align="center" cellspacing="5px" style="height: 50px;width: 90%;">
					...
					<tr>
						...
						<!--FIELD | FORNECEDOR-->
						<td style="width: 70%;">
							<input type="text" name="fornecedor" maxlength="24" onKeypress="if (event.keyCode == 32) event.returnValue = false;" style="background-color: #1A1E23;border-radius: 5px;color: gray;font-size: 15px;font-weight: bold;height: 32px;text-transform: uppercase;width: 96%;" required>
						</td>
					</tr>
					...
					<tr>
						...
						<!--TITULO | SERVIÇO-->
						<td align="center" style="background-color: gray;border-radius: 5px;color: #1A1E23;font-size: 15px;font-weight: bold;width: 30%;">Serviço</td>

						<!--FIELD | SERVIÇO-->
						<td style="width: 70%;">
							<input type="text" name="servico" maxlength="24" onKeypress="if (event.keyCode == 32) event.returnValue = false;" style="background-color: #1A1E23;border-radius: 5px;color: gray;font-size: 15px;font-weight: bold;height: 32px;text-transform: uppercase;width: 96%;" required>
						</td>
					</tr>
				...
				<table align="center" cellspacing="5px" style="height: 50px;margin-top: 10px;width: 90%;">
					...
					<tr>
						<td style="width: 90%;">
							<input type="submit" value="Cadastrar" style="background-color: #228B22;border-color: #006400;border-radius: 5px;color: white;font-family: calibri;font-size: 18px;font-weight: bold;height: 32px;text-transform: uppercase;width: 100%;">
						</td>
					</tr>
