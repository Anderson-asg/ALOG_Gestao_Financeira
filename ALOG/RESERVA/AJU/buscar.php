			...
			<td style="background-color: #252B30;border-radius: 10px;box-shadow: 1.5px 1.5px 1.5px black;">
				...
				<table align="center" cellspacing="5px" style="height: 120px;width: 90%;">
					...
					<tr>
						...
						<!--TITULO-->
						<td style="color: gray;font-size: 20px;font-weight: bold;vertical-align: bottom;width: 80%;">Buscar Ativo Reserva</td>
					</tr>
				...
				<!--FIM TITULO BUSCAR ATIVO RESERVA-->



				<!--FORMULARIO BUSCAR ATIVO-->
				...
				<table align="center" cellspacing="5px" style="height: 50px;margin-top: 10px;width: 90%;">
					...
					<tr>
						<td style="width: 90%;">
							<input type="submit" value="Buscar" style="background-color: #228B22;border-color: #006400;border-radius: 5px;color: white;font-family: calibri;font-size: 18px;font-weight: bold;height: 32px;text-transform: uppercase;width: 100%;">
						</td>
					</tr>
