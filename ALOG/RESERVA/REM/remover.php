...
<!--FORMULÁRIO-->
<form method="post" action="../../BACK-END/PHP/RESERVA/REM/remover.php">
			...
			<td style="background-color: #252B30;border-radius: 10px;box-shadow: 1.5px 1.5px 1.5px black;">				
				...
				<table align="center" cellspacing="5px" style="height: 120px;width: 90%;">
					...
					<tr>
						...
						<!--TITULO-->
						<td style="color: gray;font-size: 20px;font-weight: bold;vertical-align: bottom;width: 80%;">Remover Reserva</td>
					</tr>
						...
						<td style="width: 70%;">
							<select name="ticker" autofocus="true" style="background-color: #1A1E23;border-radius: 5px;color: gray;font-size: 15px;font-weight: bold;height: 38px;text-transform: uppercase;width: 99.4%;" required>
		                        ...
		                        while ($linha = mysqli_fetch_assoc($valida_ticker)){
									...
									echo "<option value=".$ticker.">".$ticker." ".$segmento."</option>";
