...
<!--FORMULÁRIO-->
<form method="post" action="../../BACK-END/PHP/RESERVA/CAD/cadastrar.php">



	<!--CADASTRAR RESERVA-->
	<table cellspacing="20px" style="height: 515px;width: 35%;">
		<tr>
			...
			<td style="background-color: #252B30;border-radius: 10px;box-shadow: 1.5px 1.5px 1.5px black;">
				...
				<table align="center" cellspacing="5px" style="height: 120px;width: 90%;">
					...
					<tr>
						...
						<!--TITULO-->
						<td style="color: gray;font-size: 20px;font-weight: bold;vertical-align: bottom;width: 80%;">Cadastrar Reserva</td>
					</tr>
