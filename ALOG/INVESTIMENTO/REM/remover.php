...
<!--FORMULÁRIO-->
<form method="post" action="../../BACK-END/PHP/INVESTIMENTO/REM/remover.php">
			...
			<td style="background-color: #252B30;border-radius: 10px;box-shadow: 1.5px 1.5px 1.5px black;">
				...
				<table align="center" cellspacing="5px" style="height: 120px;width: 90%;">
					...
					<tr>
						...
						<!--TITULO-->
						<td style="color: gray;font-size: 20px;font-weight: bold;vertical-align: bottom;width: 80%;">Remover Ativo</td>
					</tr>
				...
				<!--FIM TITULO REMOVER ATIVO-->



				<!--FORMULARIO REMOVER ATIVO-->
				<table align="center" cellspacing="5px" style="height: 50px;width: 90%;">
					...
					<tr>
						...
						<!--FIELD | TICKER-->
						<td style="width: 70%;">
							<select name="ticker" autofocus="true" style="background-color: #1A1E23;border-radius: 5px;color: gray;font-size: 15px;font-weight: bold;height: 38px;text-transform: uppercase;width: 99.4%;" required>
								<option value="" selected>Selecione</option>



		                        <!--PHP BUSCA APENAS TICKERS APORTADOS-->
		                        <?php

		                        //BUSCA NO BD INVESTIMENTOS APORTADOS
				...
				<table align="center" cellspacing="5px" style="height: 50px;margin-top: 10px;width: 90%;">
					...
					<tr>
						<td style="width: 90%;">
							<input type="submit" value="Remover" style="background-color: #228B22;border-color: #006400;border-radius: 5px;color: white;font-size: 18px;font-family: calibri;font-weight: bold;height: 32px;text-transform: uppercase;width: 100%;">
						</td>
					</tr>
					...
					<tr>
						<td style="width: 90%;">
							<a href="../../DASHBOARD/dashboard.php"><input type="button" value="Voltar" style="background-color: gray;border-radius: 5px;color: #1A1E23;font-size: 18px;font-family: calibri;font-weight: bold;height: 32px;text-transform: uppercase;width: 100%;"></a>
						</td>
					</tr>
				</table>
				<!--FIM BOTÕES-->
